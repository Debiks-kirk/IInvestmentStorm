...
const COLLECTION_CARD_TEXT: Record<CardId, string> = {
  luckyTickets: '至多 3 个号码，每号注入 2 金币。', tieCharm: '并列时自动保留排名，多人持有则抵消。', sleeveUpgrade: '消耗一张卡随机升一档。',
