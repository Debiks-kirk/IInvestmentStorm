...
export const ITEM_POOL: Item[] = [
  ...
  { id: 'space-trip', name: '太空旅行', value: 12, emoji: '🛰️', tone: '#655f88', category: 'transport' },
  ...
  { id: 'go-kart', name: '卡丁车', value: 7, emoji: '🛞', tone: '#c27646', category: 'transport' },
  ...
  { id: 'luxury-cruise', name: '豪华游轮', value: 13, emoji: '🚢', tone: '#477f96', category: 'transport' },
  ...
  { id: 'resort', name: '度假村', value: 14, emoji: '🌴', tone: '#579181', category: 'property' },
